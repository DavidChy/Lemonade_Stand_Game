...
namespace Lemonade_Stand
{
    public static class UserInterface
    {
        ...
        public static void ShowRules(Player player1)
        {
            ...
            Console.WriteLine("----------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine($"Yo! My homie {player1.Name}! Your objective is to make as much money as possible by selling ''lemonade'' at your new stand!");
            ...
            Console.WriteLine("3. Set the price and recipe.");
            Console.WriteLine("4. Start slanging some lemonade! \n\n");
